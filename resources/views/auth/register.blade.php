...
<body>
  <div class="container">
    ...
    <div class="register-card">
      <div class="register-logo-container" style="height: 60px; overflow: hidden; display: flex; align-items: center; justify-content: center;">
        <img src="https://www.payninja.in/assets/images/logo.png" alt="PayNinja Logo" class="register-logo" style="object-fit: contain;" />
      </div>
      <h2>Register</h2>
      <form method="POST" action="{{ route('register') }}">
        @csrf
        <div style="display: flex; gap: 1rem; width: 100%; margin-bottom: 1.5rem;">
          <div style="flex: 1; display: flex; flex-direction: column;">
            <label for="name">Name</label>
            <input id="name" type="text" name="name" required autocomplete="name" autofocus placeholder="Your full name" />
          </div>
          <div style="flex: 1; display: flex; flex-direction: column;">
            <label for="email">Email</label>
            <input id="email" type="email" name="email" required autocomplete="email" placeholder="company@example.com" />
          </div>
        </div>
        <div style="display: flex; gap: 1rem; width: 100%; margin-bottom: 1.5rem;">
          <div style="flex: 1; display: flex; flex-direction: column;">
